...
router.put('/updateEvaDate',auth.isSignedIn, controller.updateEvaDate);
...
router.put('/cancleAttend',auth.isSignedIn, controller.cancleAttend);
router.put('/recoverAttend',auth.isSignedIn, controller.recoverAttend);
router.put('/batchCancleAttend',auth.isSignedIn, controller.batchCancleAttend);
router.put('/batchUpdateAttend',auth.isSignedIn, controller.batchUpdateAttend);
